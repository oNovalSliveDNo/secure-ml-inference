...
- **Протокол**: Клиент шифрует стандартизованные и кодированные в целые числа признаки; сервер вычисляет зашифрованный линейный score; клиент расшифровывает score и выполняет постобработку: сигмоида + порог для классификации, прямое значение для регрессии.
...
Клиент:
  ...
  └─ Regression: прямой числовой прогноз
```
